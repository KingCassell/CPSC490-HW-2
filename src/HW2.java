 ...
 * Date: Spring 2022
 * Auth: S. Bowers
 * Desc: Basic performance test driver for HW-2
 */
...
public class HW2 {
  ...
  public static double timeSparseBFS(Graph<Integer> g) {
  ...
  public static void performanceTests() {
    ...
    System.out.println("# Column 2: bfs sparse undirected adj list");
    System.out.println("# Column 3: bfs sparse directed adj list");
    System.out.println("# Column 4: bfs sparse undirected adj matrix");
    System.out.println("# Column 5: bfs sparse directed adj matrix");
    ...
    for (int n = start; n <= end; n *= step) {
      ...
      double c1 = timeSparseBFS(g1);
      double c2 = timeSparseBFS(g2);
      double c3 = timeSparseBFS(g3);
      double c4 = timeSparseBFS(g4);
